...
public class EncounterController {
    ...
    public Number post(@RequestBody Encounter encounter) {
    ...
    public String post(@RequestBody(required = false) Collection<EncounterMonsterType> encounterMonsterTypes, @PathVariable Integer encounterId) {
        ...
        for (EncounterMonsterType encounterMonsterType : encounterMonsterTypes) {
            ...
            for (EncounterMonster encounterMonster : encounterMonsterType.getEncounterMonsters()) {
                ...
                new SimpleJdbcInsert(jdbcOperations)
                        ...
                        .execute(new BeanPropertySqlParameterSource(encounterMonster))
            }
        }
        System.out.println("post");
        return "hello, monsters";
    ...
    private int deleteEncounterMonsterTypes(Integer encounterId) {
        return jdbcOperations.update("delete from encounter_monster_type where encounter_id = :encounterId", encounterId);
    }
